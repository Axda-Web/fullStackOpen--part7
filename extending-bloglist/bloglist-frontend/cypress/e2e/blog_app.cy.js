    ...
    describe('When logged in', function () {
        ...
        describe('and several blogs exist', function () {
            ...
            it('one of those can be liked', function () {
                cy.contains('My third blog with cypress')
                    .parent()
                    .find('button')
                    .as('viewButton');
            ...
            it('one of those can be deleted', function () {
                cy.contains('My second blog with cypress')
                    .parent()
                    .find('button')
                    .as('viewButton');
                cy.get('@viewButton').click();
            ...
            it('blogs are ordered according to likes', function () {
                cy.get('.blog')
                    .eq(0)
                    .should('contain', 'My first blog with cypress');
                cy.get('.blog')
                    .eq(1)
                    .should('contain', 'My second blog with cypress');
                cy.get('.blog')
                    .eq(2)
                    .should('contain', 'My third blog with cypress');
            });
        });
    });
});
